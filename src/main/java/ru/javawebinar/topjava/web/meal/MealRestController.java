...
public class MealRestController {
    ...
    public List<MealTo> getAll() {
        log.info("getAll");
        return service.getAll(SecurityUtil.authUserId(), null, null, null, null);
    }

    public List<MealTo> getFilteredList(LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
        log.info("getFilteredList with date {} to date {} with time {} to {}", startDate, endDate, startTime, endTime);
